          ...
          <div class="x_panel">
            ...
            <div class="x_content">
              ...
              <div class="form-group">
                <label class="control-label col-md-3 col-sm-3 col-xs-12" >ข้อความ <span class="required">*</span>
                </label>
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <input type="text" v-model="Texts.eventtext" class="form-control col-md-7 col-xs-12" multiple>
                </div>
              </div>
              <div class="form-group">
                <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                  <button type="button" @click="AddEventText" class="btn btn-success">เพิ่มข้อมูล</button>
                </div>
              </div>
...
new Vue({
    ...
    methods: {
        fetchViewData: function() {
              this.$http.get('manager/event/viewdata')
        ...
        AddImageAlbum: function() {
            ...
            this.$http.post('manager/event/post', formData).then((resoponse) => {
        ...
        RemoveImage: function(id) {
            ...
            if(ConfirmBox) this.$http.post('manager/event/remove', {id : id}) .then((response) => {
                  this.fetchViewData();
        ...
        AddEventText: function() {
          this.$http.post('manager/eventtext/post', this.Texts).then((resoponse) => {
              this.Notify('Success','เพิ่มรูปภาพสำเร็จ','success');
          }, (response) => {
              this.Notify('Error','กรุณากรอกข้อมูลให้ถูกต้อง','error');
          });
