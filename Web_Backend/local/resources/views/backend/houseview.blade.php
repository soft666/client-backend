...
new Vue({
    ...
    methods: {
        fetchViewData: function() {
            setTimeout(function() {
                var id = $('#albumid').val();
                this.$http.get('manager/house/viewdata/'+id)
        ...
        AddImageAlbum: function() {
            ...
            this.$http.post('manager/house/image', formData).then((resoponse) => {
        ...
        RemoveImage: function(id) {
            ...
            if(ConfirmBox) this.$http.post('manager/houseview/remove', {id : id}) .then((response) => {
                  this.fetchViewData();
